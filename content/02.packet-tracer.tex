...
\begin{figure}[htbp]
    \centerline{\includegraphics[scale=.3]{images/02.packet-tracer/extensions.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[scale=.35]{images/02.packet-tracer/bottom.png}}
...
\noindent In questo \textbf{manuale?} verranno usati i seguenti router:
...
\noindent In questo \textbf{manuale?} verranno usati i seguenti switch:
...
\noindent In questo \textbf{manuale?} verranno usati i seguenti cavi:
...
\subsubsection{Configurazione degli indirizzi IP statici} %TODO
Assegnare indirizzi IPv4 e IPv6 alle interfacce.

\begin{cmds}[Interface]{Configuration mode}{cmd:change-ip}{
    Configurare l'indirizzo IP di un'interfaccia. La prima parte di entrambi i comandi è l'\textcolor{Highlight1}{indirizzo della macchina} % TODO
}
...
\subsubsection{Modificare il nome e l'hostname di un apparato} %hostname?
