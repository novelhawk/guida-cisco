...
Una volta fatto ciò, partendo da destra, sostituiamo con gli zeri il numero di bit pari al numero di bit precedentemente calcolato. In questo caso essendo 9 il risultato sarà il seguente:
